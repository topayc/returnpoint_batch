...
import com.returnp.batch.dto.SingleDataObjectResponse;
...
public class ApplicationController  {
	...
	protected void setSuccessRespone(BaseResponse res, String title, String mes){ 
		res.setResult(AppConstants.ResponseResult.SUCCESS);
		res.setResultCode(AppConstants.ResponsResultCode.SUCCESS);	
	...
	protected void setErrorRespone(BaseResponse res, String title, String mes){ 
